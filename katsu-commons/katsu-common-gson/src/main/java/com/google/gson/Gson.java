...
public final class Gson {
  ...
  Gson(final Excluder excluder, final FieldNamingStrategy fieldNamingPolicy,
    ...
    TypeAdapterFactory hibernateTypeAdapterFactory = new HibernateTypeAdapterFactory(
        constructorConstructor, fieldNamingPolicy, excluder);

    TypeAdapterFactory mappedDataGridTypeAdapterFactory = new MappedDataGridTypeAdapterFactory(
        constructorConstructor, fieldNamingPolicy, excluder);
    ...
    factories.add(hibernateTypeAdapterFactory);
    factories.add(mappedDataGridTypeAdapterFactory);
