...
public class Loader{
    ...
    private com.abada.dwm.web.Loader webLoader;
    private com.abada.dwm.jndi.Loader jndiLoader;

    public com.abada.dwm.web.Loader getWebLoader() {
        if (webLoader == null) {
            webLoader = new com.abada.dwm.web.Loader();
        }
        return webLoader;
    }

    public com.abada.dwm.jndi.Loader getJndiLoader() {
        if (jndiLoader == null) {
            jndiLoader = new com.abada.dwm.jndi.Loader();
        }
        return jndiLoader;
    }        
