...
Ext.define('Katsu.grid.RowExpander',{
    requires: ['Katsu.Ajax','Ext.JSON','Ext.grid.feature.RowBody','Ext.grid.feature.RowWrap'],
    alias:'plugin.katsu.rowexpander',
